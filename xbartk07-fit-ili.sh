...
echo "...failing device \"loop0\""
mdadm --manage /dev/md0 --fail /dev/loop0 || echo "...failed"
echo "...removing faulty device"
mdadm --manage /dev/md0 --remove /dev/loop0 || echo "...failed"
echo "...adding replacement device"
mdadm --manage /dev/md0 --add /dev/loop4 || echo "...failed"
cat /proc/mdstat
